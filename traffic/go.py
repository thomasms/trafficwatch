...
depature_time_secs = int((depature_datetime-datetime.datetime(1970, 1, 1, 0, 0, tzinfo=pytz.timezone('UTC'))).total_seconds())
...
print("Quickest route time is: {0} minutes.".format(time_in_secs/60.))
